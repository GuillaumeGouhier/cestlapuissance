...
// JOUEUR 1 //
	...
	int is_adjacent_1(int column, int line, int vertical, int horizontal) {
		...
		if (vertical == 0) {
			if (horizontal == 1) {
				while ((tableau[line][column]) == (tableau[line][column+1])&&(tableau[line][column] == symboleJoueur1))
				{
					n++;
					column++;
				}
		...
		if (vertical == 1) {
			if (horizontal == 0) {
				while ((tableau[line][column]) == (tableau[line+1][column])&&(tableau[line][column] == symboleJoueur1))
				{
					n++;
					line++;
				}
		...
		//Diagonale haut gauche
				...
				while ((tableau[line][column]) == (tableau[line+1][column-1])&&(tableau[line][column] == symboleJoueur1))
				{
					n++;
					line++;
					column--;
...
// JOUEUR 2 //
	...
	int is_adjacent_2(int column, int line, int vertical, int horizontal) {
		...
		if (vertical == 0) {
			if (horizontal == 1) {
				while ((tableau[line][column]) == (tableau[line][column+1])&&(tableau[line][column] == symboleJoueur2))
				{
					n++;
					column++;
				}
		...
		if (vertical == 1) {
			if (horizontal == 0) {
				while ((tableau[line][column]) == (tableau[line+1][column])&&(tableau[line][column] == symboleJoueur2))
				{
					n++;
					line++;
				}
		...
		//Diagonale haut gauche
				...
				while ((tableau[line][column]) == (tableau[line+1][column-1])&&(tableau[line][column] == symboleJoueur2))
				{
					n++;
					line++;
					column--;
...
int main(int argc, char const *argv[]) {
	 ...
	 printf("\tChacun de vous a droit à 21 jetons, à vous de les utiliser à bon escient pour gagner\n");
	 ...
	 printf("\t\x1B[32mEt c'est parti! Pas besoin de chance, soyez stratège!\n\x1B[0m");
